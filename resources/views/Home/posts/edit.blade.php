...
<form action="/dasbhoard/posts/{{ $post->slug }}" method="POST" class="mb-3" enctype="multipart/form-data">
  @method('put')
  @csrf
  <div class="mb-3">
  ...
  <a href="/dasbhoard/posts" class="btn btn-primary mt-0">Back My Post</a>
  <button type="submit" class="btn btn-warning mb-0 mt-0">Update Data Post</button>
</form>

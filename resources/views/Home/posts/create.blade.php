...
<form action="/dasbhoard/posts" method="POST" class="mb-3" enctype="multipart/form-data">
  @csrf
  <div class="mb-3">
  ...
  <button type="submit" class="btn btn-secondary mb-0 mt-0">Save Data Post</button>
</form>
